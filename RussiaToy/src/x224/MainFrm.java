...
//		jButtonStart.setText("Start !");
	...
	private void initComponents() {
		...
		//operation for the whole window
		setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
		setTitle("My first java practice: RussiaToy");
		setResizable(false);
		
		//operation for the box window
		jMainTbl.setBackground(new java.awt.Color(0, 102, 102));
		jMainTbl.setOpaque(true);

		//operation for start button
		jButtonStart.setActionCommand("jButtonStart");
		jButtonStart.setText("Start !");
		...
		jScrollPaneSig.setBorder(javax.swing.BorderFactory.createEtchedBorder());
	...
	private void setDefaultCloseOperation(Class<WindowConstants> class1) {
